...
- 【重要】過去のありふれたアイデアや完全な空想（例：人の頭の上に数字が見える等）は絶対に避けてください。実在する地名、建物、歴史上の事件、実在の人物、または現存する物を題材にして、本当にありそうなリアリティのある都市伝説を作成してください。
- 【重要】台本の中で「これは100％創作ですが」「ここから話すのはフィクションです」といったメタな発言（前置き）は絶対にしないでください。視聴者が「本当にあった話かもしれない」と錯覚するように、事実のように淡々と語ってください。
"""
